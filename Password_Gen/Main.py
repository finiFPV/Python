...
def generate_random_password():
    ...
    if (
        ...
        and generation_options != 1
        and generation_options != 2
        and generation_options != 3
        and generation_options != 4
        and generation_options != 5
        and generation_options != 6
    ):
    ...
    if (
        generation_options == 0
        or generation_options == 3
        or generation_options == 4
        or generation_options == 6
    ):
